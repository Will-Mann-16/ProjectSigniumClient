                ...
                <Toggle initial={false}>
                    {({on, toggle}) =>
                        ...
                        <div class="icon-bar">
                            ...
                            <a onClick={toggle}>Filter <i class="fa fa-filter"></i></a>
                        </div>
                        {on && <div>
                            <input class="form-input" name="search" placeholder="Search" onChange={(e) => this.setState({...this.state, filters: {...this.state.filters, search: e.target.value}})}/>
                        </div>}
                        </div>
                    }
                </Toggle>
